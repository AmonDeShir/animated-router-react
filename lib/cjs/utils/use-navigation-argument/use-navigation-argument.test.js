...
var use_navigation_argument_data_1 = __importDefault(require("./use-navigation-argument.data"));
var navigation_context_1 = require("../../reducer/context/navigation-context");
var use_navigation_argument_1 = __importDefault(require("./use-navigation-argument"));
...
describe("useNavigationArgument", function () {
    it("should return null if navigation.argument is an empty string", function () {
        var result = (0, react_hooks_1.renderHook)(function () { return (0, use_navigation_argument_1.default)(); }, {
            wrapper: wrapper(''),
        }).result;
    ...
    it("should return parsed argument if navigation.argument can be parse by json.parse", function () {
        var data = encodeURI(JSON.stringify(use_navigation_argument_data_1.default));
        var result = (0, react_hooks_1.renderHook)(function () { return (0, use_navigation_argument_1.default)(); }, {
            wrapper: wrapper(data),
        }).result;
        expect(result.current).toEqual(use_navigation_argument_data_1.default);
    });
});
